...
async def llm_reply_to_text_v2(
    ...
    try:
        ...
        # Strict context-aware LLM prompt for CRM assistant
        llm_instruction = (
            "# CRM WhatsApp Assistant — Context-Aware LLM Prompt\n"
            "\n"
            "## SYSTEM ROLE\n"
            ...
            "2. Extract structured data (events, contact info)\n"
            "3. Use ONLY the resolved lead provided by backend\n"
            "4. Generate a clear response\n"
            "\n"
            "---\n"
            "\n"
            "## 🔴 BACKEND GUARANTEE (IMPORTANT)\n"
            "The backend has already:\n"
            "* Checked `context_message_id` (reply messages)\n"
            "* Matched it with MongoDB (`message_id → leadId`)\n"
            "* If not found, fallback to phone-based lookup\n"
            "* Determined a FINAL `resolved_leadId`\n"
            "\n"
            ...
            "---\n"
            "\n"
            "### 2. DO NOT HANDLE CONTEXT\n"
            "* DO NOT use `context_message_id`\n"
            "* DO NOT perform mapping logic\n"
            "* DO NOT infer lead from message history\n"
            "\n"
            ...
            "* meetingDateTime (ISO format)\n"
            "* rawText\n"
            "\n"
            "Rules:\n"
            "* Resolve relative dates using current date\n"
            "* If time missing → default to \"10:00:00\"\n"
            ...
            "* If message seems repeated → respond safely\n"
            "\n"
            "---\n"
            "\n"
            "## INPUT\n"
            ...
            "## LOGIC SUMMARY\n"
            "\n"
            "* Reply message → already mapped via context_id → resolved_leadId given\n"
            "* New message → resolved via phone fallback\n"
            "* No lead → create new\n"
            "\n"
            "👉 You ONLY act on resolved_leadId\n"
            "\n"
            "---\n"
            "\n"
            "## EXAMPLES\n"
            ...
            "  \"rawText\": \"Tuesday\"\n"
            "},\n"
            "\"reply\": \"Your meeting has been scheduled for Tuesday at 10 AM.\"\n"
            "}\n"
            "\n"
            "---\n"
            "\n"
